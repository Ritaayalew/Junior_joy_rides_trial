        ...
        Scaffold(
            ...
            Box(
                ...
                Column(
                    ...
                    // Placeholder input field with HintInputField style
                    HintInputField(
                        value = "",
                        hint = "Search Interviews or Birthdays",
                        leadingIcon = Icons.Default.Search,
                        onValueChange = { /* Handle search input */ },
                        onFocusChange = { /* Handle focus change */ },
                    ...
                    Box(
                        modifier = Modifier
                            .fillMaxWidth()
                            .weight(1f) // Allow the NavHost content to take remaining space
                    ) {
                        NavHost(navController = localNavController, startDestination = "interviewManagement") {
                            composable("interviewManagement") {
